export function pageLogin() {
    return `
        <h1 class="text-center py-6">Inicio de Sesion</h1>
                <button
          class="  bg-gray-600/40 rounded text-white justify-center items-center flex  ml-6 my-4 hover:bg-gray-300/40 hover:scale-105 active:scale-95 cursor-pointer h-[2rem]  w-[3rem]  "><svg
        ...
        <article
                ...
                <form id="formLogin">
                    <fieldset class="grid grid-cols-1 gap-4">
                        ...
                        <input class="rounded-sm bg-stone-50/100 p-2" type="text" name="usuario" id="usuario"
                            placeholder=" Alejandro82" required maxlength="24" minlength="5" >
                        ...
                        <input class="rounded-sm bg-stone-50/100 p-2" type="password" name="Contraseña" id="contraseña"
                            placeholder=" contra1234" required maxlength="24" minlength="5" autocomplete="current-password">
            ...
            <footer class="text-center my-4">
                <p class="  decoration-blue-400">¿Olvidaste tu contraseña?</p>
                <br>
